package graph.axemaker;

import java.text.DecimalFormat;

import graph.data.graph2d.axis.ValuedRulerElement;
import graph.data.graph3d.Margin;
import graph.data.graph3d.element.axis.Axis3D;
import graph.data.graph3d.element.axis.AxisX3D;
import graph.data.graph3d.element.axis.AxisY3D;
import graph.data.graph3d.element.axis.AxisZ3D;
